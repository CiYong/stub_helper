...
#ifndef DTEST_LOGGER_H
#define DTEST_LOGGER_H
...
{
public:
    static Logger* create_instance(bool console, bool timestamp, const char *file);
    static Logger* instance();

    void log(const char* fmt, ...);

private:
    Logger(bool console, bool timestamp, const char* file);
    virtual ~Logger();
