...
public:
    ...
    virtual void set(const char* key, int value) const;
    virtual void set(const char* key, void* value, size_t size) const;
    virtual bool get(const char *key, void **value) const;
