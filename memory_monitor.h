...
#ifndef DTEST_MEMORY_MONITOR_H
#define DTEST_MEMORY_MONITOR_H
...
public:
    ...
    void* allocate(size_t size, const char* filename, const size_t line, const char* function);
